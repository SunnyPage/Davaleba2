...
public class DavalebaTestContainer extends TestContainer {

    public DavalebaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/davaleba/app.properties",
    ...
    public static class Common extends DavalebaTestContainer {

        public static final DavalebaTestContainer.Common INSTANCE = new DavalebaTestContainer.Common();
